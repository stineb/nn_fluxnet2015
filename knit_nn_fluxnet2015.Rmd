...
The following figure shows a visualisation of the mean cluster response (centers)
...
The following figure shows a histogram of the greenness changes (median of third bin, representing days 21-40 into fLUE droughts) by cluster 1 and 2.
